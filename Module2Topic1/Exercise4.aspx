...
<asp:Content ID="Exercise4Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form runat="server">
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100" ErrorMessage="Please enter a valid age between 0 and 100." /><br />
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Please enter a valid email address." /><br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" ErrorMessage="Emails do not match." /><br />
